...
Examples:
  ...
  api-cli create-step-assert-exists "Login button" 1
  api-cli create-step-assert-exists "Success message"  # Auto-increment position
  
  # Override checkpoint explicitly
  api-cli create-step-assert-exists "Login button" 1 --checkpoint 1678318`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			output := &StepOutput{
				...
				ParsedStep:   fmt.Sprintf("see \"%s\"", element),
