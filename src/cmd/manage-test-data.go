...
func createTestDataTable(client *virtuoso.Client, name, description, columnsStr, format string) error {
	if name == "" {
...
func importTestDataFromCSV(client *virtuoso.Client, csvPath, tableID, format string) error {
	if tableID == "" {
...
func exportTestDataToCSV(client *virtuoso.Client, csvPath, tableID, format string) error {
	if tableID == "" {
...
func getTestDataTable(client *virtuoso.Client, tableID, format string) error {
	table, err := client.GetTestDataTable(tableID)
	if err != nil {
